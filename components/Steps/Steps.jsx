...
const Steps = ({ Content }) => {
    ...
    return (
        <div className="p-3 md:px-20 flex flex-col justify-center items-center ">

            {
                Content.map((each) => (
                        <div key={each.step} className="w-full flex justify-center items-center flex-col md:flex-row p-2 md:p-4 gap-1 md:gap-12 h-full bg-gray-100 rounded-2xl my-2 ">
