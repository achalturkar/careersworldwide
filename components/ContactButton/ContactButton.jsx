...
const ContactButton = () =>{
    ...
    return(
        <div className="relative w-full bg-blue-950 p-8 flex flex-col justify-center items-center gap-4 mt-4">
          ...
          <div className=" absolute w-10 h-10 md:w-20 md:h-20 rounded-full bg-gray-50 -top-4 start-10 md:start-80">
