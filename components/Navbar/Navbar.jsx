  ...
  return (
    <header className="font-poppins fixed top-0  w-full z-50 font-poppins bg-gradient-to-r from-blue-900 to-orange-500">
      ...
      <nav className="bg-white text-black flex items-center justify-between px-2 md:justify-around   ">
        ...
        <ul className="hidden lg:flex items-center gap-6 font-bold">
          ...
          <li className="relative group cursor-pointer">
            ...
            <ul className="absolute top-6 left-var(40%) bg-white shadow-md rounded-md text-md w-68 hidden group-hover:block z-10">
              ...
              <li className="p-1 hover:bg-gray-100 hover:text-blue-900 "><Link href="/services/non-it">Contractual Recruitment</Link></li>
              <li className="p-1 hover:bg-gray-100 hover:text-blue-900"><Link href="/services/non-it">Payroll Management</Link></li>
              <li className="p-1 hover:bg-gray-100 hover:text-blue-900"><Link href="/services/payroll">Permanent Recruitment</Link></li>
              <li className="p-1 hover:bg-gray-100 hover:text-blue-900"><Link href="/services/payroll">Recruitment Process Outsourcing</Link></li>
            </ul>
          </li>
        ...
        <button className="hidden lg:block p-2 bg-green-500 rounded-lg text-white font-semibold">Enquiry</button>
      ...
      {/* Mobile menu */}
      <div className={`lg:hidden fixed top-0 right-0 h-full min-w-1/2 bg-white text-black p-4 transform transition-transform duration-300 z-40 ${menuOpen ? "translate-x-0" : "translate-x-full"}`}>
        ...
        <ul className="flex flex-col gap-4 font-semibold">
          ...
          <li className="cursor-pointer" onClick={() => setServicesOpen(!servicesOpen)}>
            ...
            {servicesOpen && (
              ...
              <li className="p-2 hover:bg-gray-100 hover:text-blue-900 "><Link href="/services/headhunting">Head Huntings</Link></li>
              <li className="p-2 hover:bg-gray-100 hover:text-blue-900 "><Link href="/services/non-it">Contractual Recruitment</Link></li>
              <li className="p-2 hover:bg-gray-100 hover:text-blue-900 "><Link href="/services/non-it">Payroll Management</Link></li>
              <li className="p-2 hover:bg-gray-100 hover:text-blue-900 "><Link href="/services/payroll">Permanent Recruitment</Link></li>
              <li className="p-2 hover:bg-gray-100 hover:text-blue-900 "><Link href="/services/payroll">Recruitment Process Outsourcing</Link></li>
              </ul>
            )}
          </li>
